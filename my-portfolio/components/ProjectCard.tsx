...
const ProjectCard = ({ image, title, text, link}: Props) => {
  ...
  return (
    ...
    className='w-[450px] h-[280px] rounded-md cursor-pointer '>
        ...
        <Link href={link} target="_blank" rel="noopener noreferrer" className=' top-4 rounded-[20px]  relative  bg-orange-500 hover:bg-orange-400 px-5 py-3 text-lg text-white max-w-[200px]'>
        GitHub
              </Link>
